...
tf.app.flags.DEFINE_string('dataset_path', '/tmp/data/datasets/mnist.npz', 'dataset path for mnist')
tf.app.flags.DEFINE_string('model_path', '/tmp/data/tfestimator_example/', 'model path for mnist')
...
def input_fn(mode, input_context=None):
    ...
    result_dataset = result_dataset.apply(
        tf.data.experimental.shuffle_and_repeat(buffer_size=BUFFER_SIZE, count=10))
